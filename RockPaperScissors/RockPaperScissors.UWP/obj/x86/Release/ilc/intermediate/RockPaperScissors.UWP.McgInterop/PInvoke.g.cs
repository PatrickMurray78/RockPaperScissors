...
namespace __Interop
{
	...
	{
		// Signature, TerminateProcess, [fwd] [return] [EETypeRva:0x0003F06C] bool__System.Boolean, [fwd] [in] [EETypeRva:0x00041CC4] Microsoft_Win32_SafeHandles_SafeProcessHandle__System_Diagnostics_Process____w64 int, [fwd] [in] [EETypeRva:0x0004157C] int__int, 
		...
		// Signature, GetExitCodeProcess, [fwd] [return] [EETypeRva:0x0003F06C] bool__System.Boolean, [fwd] [in] [EETypeRva:0x00041CC4] Microsoft_Win32_SafeHandles_SafeProcessHandle__System_Diagnostics_Process____w64 int, [fwd] [out] [managedbyref] [nativebyref] [EETypeRva:0x0004157C] int__int, 
		...
		// Signature, GetCurrentProcess, [fwd] [return] [EETypeRva:0x00041CC4] Microsoft_Win32_SafeHandles_SafeProcessHandle__System_Diagnostics_Process____w64 int, 
		...
		// Signature, DuplicateHandle, [fwd] [return] [EETypeRva:0x0003F06C] bool__System.Boolean, [fwd] [in] [EETypeRva:0x00041CC4] Microsoft_Win32_SafeHandles_SafeProcessHandle__System_Diagnostics_Process____w64 int, [fwd] [in] [EETypeRva:0x00041CC4] System_Runtime_InteropServices_SafeHandle____w64 int, [fwd] [in] [EETypeRva:0x00041CC4] Microsoft_Win32_SafeHandles_SafeProcessHandle__System_Diagnostics_Process____w64 int, [fwd] [out] [managedbyref] [nativebyref] [EETypeRva:0x00041CC4] Microsoft_Win32_SafeHandles_SafeWaitHandle__System_Private_CoreLib____w64 int, [fwd] [in] [EETypeRva:0x0004157C] int__int, [fwd] [in] [EETypeRva:0x0003F06C] bool__System.Boolean, [fwd] [in] [EETypeRva:0x0004157C] int__int, 
		...
		// Signature, OpenProcess, [fwd] [return] [EETypeRva:0x00041CC4] Microsoft_Win32_SafeHandles_SafeProcessHandle__System_Diagnostics_Process____w64 int, [fwd] [in] [EETypeRva:0x0004157C] int__int, [fwd] [in] [EETypeRva:0x0003F06C] bool__System.Boolean, [fwd] [in] [EETypeRva:0x0004157C] int__int, 
		...
		// Signature, GetProcessId, [fwd] [return] [EETypeRva:0x0004157C] int__int, [fwd] [in] [EETypeRva:0x00041CC4] Microsoft_Win32_SafeHandles_SafeProcessHandle__System_Diagnostics_Process____w64 int, 
		...
		// Signature, GetComputerName, [fwd] [return] [EETypeRva:0x0004157C] int__int, [fwd] [in] [EETypeRva:0x000410CC] rg_char__wchar_t *, [fwd] [in] [out] [managedbyref] [nativebyref] [EETypeRva:0x0004157C] uint__unsigned int, 
		...
		{
			// Setup
			ushort* unsafe_lpBuffer;
			int unsafe___value;
			// Marshalling
			fixed (char* pinned_lpBuffer = ((lpBuffer != null 
						&& lpBuffer.Length == 0) ? new char[1] : lpBuffer))
			{
				unsafe_lpBuffer = (ushort*)pinned_lpBuffer;
		...
		// Signature, EnumProcesses, [fwd] [return] [EETypeRva:0x0003F06C] bool__System.Boolean, [fwd] [in] [EETypeRva:0x000410CC] rg_int__int *, [fwd] [in] [EETypeRva:0x0004157C] int__int, [fwd] [out] [managedbyref] [nativebyref] [EETypeRva:0x0004157C] int__int, 
		...
		// Signature, GetCurrentProcess__0, [fwd] [return] [EETypeRva:0x0004157C] System_IntPtr____w64 int, 
		...
		// Signature, CloseHandle__0, [fwd] [return] [EETypeRva:0x0003F06C] bool__System.Boolean, [fwd] [in] [EETypeRva:0x0004157C] System_IntPtr____w64 int, 
	...
	{
		// Signature, LookupPrivilegeValue, [fwd] [return] [EETypeRva:0x0003F06C] bool__System.Boolean, [fwd] [in] [EETypeRva:0x000401D0] string__wchar_t *, [fwd] [in] [EETypeRva:0x000401D0] string__wchar_t *, [fwd] [out] [managedbyref] [nativebyref] [EETypeRva:0x0004196C] __Interop_Advapi32_LUID__System_Diagnostics_Process____Interop_Advapi32_LUID__System_Diagnostics_Process, 
		...
		// Signature, OpenProcessToken, [fwd] [return] [EETypeRva:0x0003F06C] bool__System.Boolean, [fwd] [in] [EETypeRva:0x00041CC4] Microsoft_Win32_SafeHandles_SafeProcessHandle__System_Diagnostics_Process____w64 int, [fwd] [in] [EETypeRva:0x0004157C] int__int, [fwd] [out] [managedbyref] [nativebyref] [EETypeRva:0x00041CC4] Microsoft_Win32_SafeHandles_SafeTokenHandle__System_Diagnostics_Process____w64 int, 
		...
		// Signature, AdjustTokenPrivileges, [fwd] [return] [EETypeRva:0x0003F06C] bool__System.Boolean, [fwd] [in] [EETypeRva:0x00041CC4] Microsoft_Win32_SafeHandles_SafeTokenHandle__System_Diagnostics_Process____w64 int, [fwd] [in] [EETypeRva:0x0003F06C] bool__System.Boolean, [fwd] [in] [EETypeRva:0x000418A4] __Interop_Advapi32_TokenPrivileges__System_Diagnostics_Process____Interop_Advapi32_TokenPrivileges__System_Diagnostics_Process *, [fwd] [in] [EETypeRva:0x0004157C] int__int, [fwd] [in] [EETypeRva:0x0004157C] System_IntPtr____w64 int, [fwd] [in] [EETypeRva:0x0004157C] System_IntPtr____w64 int, 
					...
					global::System.IntPtr ReturnLength)
		{
			...
			try
			{
				// Marshalling
				TokenHandle.DangerousAddRef(ref addRefed);
				unsafe_NewState = (global::_.Interop_Advapi32_TokenPrivileges__System_Diagnostics_Process__Impl.UnsafeType*)global::__Interop.McgHelpers.CoTaskMemAllocAndZeroMemory(new global::System.IntPtr(sizeof(global::_.Interop_Advapi32_TokenPrivileges__System_Diagnostics_Process__Impl.UnsafeType)));
			...
			{
				// Cleanup
				global::System.Runtime.InteropServices.ExternalInterop.SafeCoTaskMemFree(unsafe_NewState);
			}
		}
		...
		// Signature, OpenProcessToken__0, [fwd] [return] [EETypeRva:0x0003F06C] bool__System.Boolean, [fwd] [in] [EETypeRva:0x0004157C] System_IntPtr____w64 int, [fwd] [in] [EETypeRva:0x000414B4] System_Security_Principal_TokenAccessLevels__System_Security_Principal_Windows__TokenAccessLevels__System_Security_Principal_Windows, [fwd] [out] [managedbyref] [nativebyref] [EETypeRva:0x00041CC4] Microsoft_Win32_SafeHandles_SafeAccessTokenHandle__System_Security_Principal_Windows____w64 int, 
